...
import BehemothData from "../../../data/entity/enemies/behemoth";
...
class Behemoth extends AnimatedSprite implements EntityRenderer {
  ...
  constructor(private data: BehemothData, private container: AssetsContainer) {
    super(Object.values(container.assets![Behemoth.atlas].textures) as any);
    this.anchor.set(0.5);
